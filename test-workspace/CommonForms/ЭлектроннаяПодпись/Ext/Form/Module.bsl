...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.СвойстваПодписи.ПодписьВерна Тогда
		...
		Элементы.ОткрытьОписаниеОшибки.Видимость = Ложь;
	Иначе
		Элементы.ОписаниеОшибки.Видимость = ЗначениеЗаполнено(ОписаниеОшибки);
		Элементы.ОткрытьОписаниеОшибки.Видимость = ЗначениеЗаполнено(ОписаниеОшибки);
...
&НаКлиенте
Процедура ОткрытьОписаниеОшибки(Команда)
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ЗаголовокПредупреждения", НСтр("ru = 'Ошибка проверки подписи'"));
	ПараметрыФормы.Вставить("ТекстОшибкиКлиент", ОписаниеОшибки);
