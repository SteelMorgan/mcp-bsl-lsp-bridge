...
Процедура ЛицоДоверителяОформление(Форма)
	...
	Если Форма.ДоверительРеквизиты <> Неопределено И
		(Форма.ДоверительРеквизиты.ЭтоФизическоеЛицо Или
		Форма.ДоверительРеквизиты.ЭтоИндивидуальныйПредприниматель
		Или Форма.ДоверительРеквизиты.ЭтоИностраннаяОрганизация
