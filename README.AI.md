...
| `document_diagnostics` | Ошибки в файле | Зависит от количества |
...
1. document_diagnostics
   → Список ошибок с координатами

2. get_range_content (±3 строки вокруг ошибки)
   → Контекст

3. code_actions (если нужен автофикс)
```
